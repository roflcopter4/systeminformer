...
typedef struct PHSVC_API_CONNECTINFO
{
    ULONG ServerProcessId;
} PHSVC_API_CONNECTINFO, *PPHSVC_API_CONNECTINFO;

typedef union PHSVC_API_PLUGIN
{
    struct
    {
...
typedef union PHSVC_API_EXECUTERUNASCOMMAND
{
    struct
    {
        ULONG ProcessId;
...
typedef union PHSVC_API_UNLOADDRIVER
{
    struct
    {
        PVOID BaseAddress;
...
typedef enum PHSVC_API_CONTROLPROCESS_COMMAND
{
...
typedef union PHSVC_API_CONTROLPROCESS
{
    struct
    {
        HANDLE ProcessId;
...
typedef enum PHSVC_API_CONTROLSERVICE_COMMAND
{
...
typedef union PHSVC_API_CONTROLSERVICE
{
    struct
    {
        PH_RELATIVE_STRINGREF ServiceName;
...
typedef union PHSVC_API_CREATESERVICE
{
    struct
    {
...
typedef union PHSVC_API_CHANGESERVICECONFIG
{
    struct
    {
        PH_RELATIVE_STRINGREF ServiceName;
...
typedef union PHSVC_API_CHANGESERVICECONFIG2
{
    struct
    {
        PH_RELATIVE_STRINGREF ServiceName;
...
typedef union PHSVC_API_SETTCPENTRY
{
    struct
    {
        ULONG State;
...
typedef enum PHSVC_API_CONTROLTHREAD_COMMAND
{
...
typedef union PHSVC_API_CONTROLTHREAD
{
    struct
    {
        HANDLE ThreadId;
...
typedef union PHSVC_API_ADDACCOUNTRIGHT
{
    struct
    {
...
typedef union PHSVC_API_ISSUEMEMORYLISTCOMMAND
{
    struct
    {
...
typedef union PHSVC_API_POSTMESSAGE
{
    struct
    {
        HWND hWnd;
...
typedef union PHSVC_API_CREATEPROCESSIGNOREIFEODEBUGGER
{
    struct
    {
        PH_RELATIVE_STRINGREF FileName;
...
typedef union PHSVC_API_SETSERVICESECURITY
{
    struct
    {
        PH_RELATIVE_STRINGREF ServiceName;
...
typedef union PHSVC_API_WRITEMINIDUMPPROCESS
{
    struct
    {
...
typedef union PHSVC_API_PROCESSHEAPINFORMATION
{
    struct
    {
        ULONG ProcessId;
...
typedef union PHSVC_API_PAYLOAD
{
...
typedef struct PHSVC_API_MSG
{
    PORT_MESSAGE h;
    PHSVC_API_PAYLOAD p;
} PHSVC_API_MSG, *PPHSVC_API_MSG;

typedef struct PHSVC_API_MSG64
{
    PORT_MESSAGE64 h;
    PHSVC_API_PAYLOAD p;
