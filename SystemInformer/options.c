...
typedef struct PHP_HKURUN_ENTRY
{
    PPH_STRING Value;
    //PPH_STRING Name;
...
typedef struct PH_OPTIONS_ADVANCED_CONTEXT
{
...
typedef enum PH_OPTIONS_ADVANCED_TREE_ITEM_MENU
{
...
typedef enum PH_OPTIONS_ADVANCED_COLUMN_ITEM
{
...
typedef struct PH_OPTIONS_ADVANCED_ROOT_NODE
{
