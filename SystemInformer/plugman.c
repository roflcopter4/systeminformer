...
typedef struct PH_PLUGMAN_CONTEXT
{
    HWND WindowHandle;
    HWND TreeNewHandle;
...
typedef enum PH_PLUGIN_TREE_ITEM_MENU
{
...
typedef enum PH_PLUGIN_TREE_COLUMN_ITEM
{
...
typedef struct PH_PLUGIN_TREE_ROOT_NODE
{
...
typedef struct PLUGIN_DISABLED_CONTEXT
{
