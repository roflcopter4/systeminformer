...
typedef enum ENVIRONMENT_TREE_COLUMN_ITEM
{
...
typedef enum PROCESS_ENVIRONMENT_TREENODE_TYPE
{
...
typedef struct PHP_PROCESS_ENVIRONMENT_TREENODE
{
    PH_TREENEW_NODE Node;
    PH_STRINGREF TextCache[ENVIRONMENT_COLUMN_ITEM_MAXIMUM];

    struct PHP_PROCESS_ENVIRONMENT_TREENODE* Parent;
    PPH_LIST Children;
    BOOLEAN HasChildren;
...
typedef struct EDIT_ENV_DIALOG_CONTEXT
{
