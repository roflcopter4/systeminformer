...
typedef struct PH_THREAD_STACK_CONTEXT
{
    HANDLE ProcessId;
    HANDLE ThreadId;
    HANDLE ThreadHandle;
...
typedef struct THREAD_STACK_ITEM
{
...
typedef enum PH_STACK_TREE_COLUMN_ITEM_NAME
{
...
typedef struct PH_STACK_TREE_ROOT_NODE
{
...
typedef enum PH_THREAD_STACK_MENUITEM
{
