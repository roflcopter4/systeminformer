...
typedef struct KPHM_OPEN_PROCESS_TOKEN
{
    NTSTATUS Status;
...
typedef struct KPHM_OPEN_PROCESS_JOB
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    ACCESS_MASK DesiredAccess;
...
typedef struct KPHM_TERMINATE_PROCESS
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    NTSTATUS ExitStatus;
...
typedef struct KPHM_READ_VIRTUAL_MEMORY_UNSAFE
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    PVOID BaseAddress;
...
typedef struct KPHM_OPEN_THREAD
{
    NTSTATUS Status;
...
typedef struct KPHM_OPEN_THREAD_PROCESS
{
    NTSTATUS Status;
    HANDLE ThreadHandle;
    ACCESS_MASK DesiredAccess;
...
typedef struct KPHM_CAPTURE_STACK_BACKTRACE_THREAD
{
    NTSTATUS Status;
    HANDLE ThreadHandle;
    ULONG FramesToSkip;
...
typedef struct KPHM_ENUMERATE_PROCESS_HANDLES
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    PVOID Buffer;
...
typedef struct KPHM_QUERY_INFORMATION_OBJECT
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    HANDLE Handle;
...
typedef struct KPHM_SET_INFORMATION_OBJECT
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    HANDLE Handle;
...
typedef struct KPHM_OPEN_DRIVER
{
    NTSTATUS Status;
...
typedef struct KPHM_QUERY_INFORMATION_DRIVER
{
    NTSTATUS Status;
    HANDLE DriverHandle;
...
typedef struct KPHM_QUERY_INFORMATION_PROCESS
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
...
typedef struct KPHM_SET_INFORMATION_PROCESS
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    KPH_PROCESS_INFORMATION_CLASS ProcessInformationClass;
...
typedef struct KPHM_SET_INFORMATION_THREAD
{
    NTSTATUS Status;
    HANDLE ThreadHandle;
...
typedef struct KPHM_SYSTEM_CONTROL
{
    NTSTATUS Status;
...
typedef struct KPHM_ALPC_QUERY_INFORMATION
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    HANDLE PortHandle;
...
typedef struct KPHM_QUERY_INFORMATION_FILE
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    HANDLE FileHandle;
...
typedef struct KPHM_QUERY_VOLUME_INFORMATION_FILE
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    HANDLE FileHandle;
...
typedef struct KPHM_DUPLICATE_OBJECT
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
    HANDLE SourceHandle;
...
typedef struct KPHM_QUERY_PERFORMANCE_COUNTER
{
    LARGE_INTEGER PerformanceCounter;
    LARGE_INTEGER PerformanceFrequency;
} KPHM_QUERY_PERFORMANCE_COUNTER, *PKPHM_QUERY_PERFORMANCE_COUNTER;

typedef struct KPHM_CREATE_FILE
{
    NTSTATUS Status;
    PHANDLE FileHandle;
    ACCESS_MASK DesiredAccess;
...
typedef struct KPHM_QUERY_INFORMATION_THREAD
{
    NTSTATUS Status;
    HANDLE ThreadHandle;
    KPH_THREAD_INFORMATION_CLASS ThreadInformationClass;
...
typedef struct KPHM_QUERY_SECTION
{
    NTSTATUS Status;
...
typedef struct KPHM_COMPARE_OBJECTS
{
    NTSTATUS Status;
    HANDLE ProcessHandle;
...
typedef struct KPHM_RELEASE_DRIVER_UNLOAD_PROTECTION
{
    NTSTATUS Status;
    LONG PreviousCount;
    LONG ClientPreviousCount;
...
typedef struct KPHM_GET_CONNECTED_CLIENT_COUNT
{
    ULONG Count;
} KPHM_GET_CONNECTED_CLIENT_COUNT, *PKPHM_GET_CONNECTED_CLIENT_COUNT;

typedef struct KPHM_ACTIVATE_DYNDATA
{
    NTSTATUS Status;
    PBYTE DynData;
    ULONG DynDataLength;
...
typedef struct KPHM_PROCESS_CREATE
{
...
typedef struct KPHM_DEBUG_PRINT
{
...
typedef struct KPHM_PROCESS_HANDLE_PRE_CREATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_PROCESS_HANDLE_POST_CREATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_PROCESS_HANDLE_PRE_DUPLICATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_PROCESS_HANDLE_POST_DUPLICATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_THREAD_HANDLE_PRE_CREATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_THREAD_HANDLE_POST_CREATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_THREAD_HANDLE_PRE_DUPLICATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_THREAD_HANDLE_POST_DUPLICATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_DESKTOP_HANDLE_PRE_CREATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_DESKTOP_HANDLE_POST_CREATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_DESKTOP_HANDLE_PRE_DUPLICATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_DESKTOP_HANDLE_POST_DUPLICATE
{
    CLIENT_ID ContextClientId;
...
typedef struct KPHM_REQUIRED_STATE_FAILURE
{
    CLIENT_ID ClientId;
    enum KPH_MESSAGE_ID MessageId;
