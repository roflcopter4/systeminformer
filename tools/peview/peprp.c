...
typedef enum PVP_IMAGE_GENERAL_CATEGORY
{
...
typedef enum PVP_IMAGE_GENERAL_INDEX
{
...
typedef struct PVP_PE_GENERAL_CONTEXT
{
    HWND WindowHandle;
    HWND ListViewHandle;
...
typedef struct IMAGE_DEBUG_REPRO_ENTRY
{
    ULONG Length;
    BYTE Buffer[1];
} IMAGE_DEBUG_REPRO_ENTRY, *PIMAGE_DEBUG_REPRO_ENTRY;

typedef struct IMAGE_DEBUG_VC_FEATURE_ENTRY
{
...
typedef struct PVP_ENTROPY_RESULT
{
    DOUBLE ImageEntropy;
    DOUBLE ImageAvgMean;
