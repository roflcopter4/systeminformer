...
typedef struct PV_PE_CERTIFICATE_CONTEXT
{
    HWND WindowHandle;
    HWND LabelHandle;
    HWND SearchHandle;
...
typedef enum PV_CERTIFICATE_TREE_COLUMN_NAME
{
...
typedef enum PV_CERTIFICATE_NODE_TYPE
{
...
typedef struct PV_CERTIFICATE_NODE
{
    ...
    struct PV_CERTIFICATE_NODE* Parent;
    PPH_LIST Children;
...
typedef struct PV_CERT_ENUM_CONTEXT
{
